...
public class MouseInputAdapterForSetupButtonClick extends MouseInputAdapter {
	...
	private MouseInputAdapterForSetupButtonClick(JPanel panelToDrawOn, Job2dDriver driver) {
		this.panelToDrawOn = panelToDrawOn;
		this.driver = driver;
	}

	public static void enable(JPanel panelToDrawOn, Job2dDriver driver) {
		panelToDrawOn.addMouseListener(new MouseInputAdapterForSetupButtonClick(panelToDrawOn, driver));
	}
